...
#define MAIN_CANBUS_VERSION_MAJOR 2
#define MAIN_CANBUS_VERSION_MINOR 110
#define MAIN_CANBUS_VERSION_BUILD 0x47AB1E0D         // 32 bit hash code for the dbc file
...
typedef enum
{
    ...
    CAN_ID_STARTUP_ERROR    =    0x023,    //    StartupErrorMsg:  bit0: startupVersionError; bit1: bmsStatus; bit2: bmsErrLevel; bit3: bmsPosRelayOpen; bit4: startupSafetyRelayOpen; 
    CAN_ID_ERROR_DRIVE_EXT    =    0x024,    //    ErrorDriveExt:  bit0: DrvextObsValidationCommsError; bit1: DrvextMotorNoResp; bit2: DrvextSafetyRelayOpen; 
    ...
    CAN_ID_ERROR_TRANS    =    0x026,    //    ErrorTrans:  bit0: TransJoystickDisconnect; bit1: TransJoystickCommsError; bit2: TransJoystickCentreError; bit3: TransSafetyRelayOpen; 
    ...
    CAN_ID_MANAGEMENT_ERROR    =    0x02B,    //    ManagementError:  bit0: monitorError; bit1: mgtStatusError; bits2-7: reserved; bits8-9: GPSOff; bits10-15: reserved1; bits16-17: drvGPSOff; 
    CAN_ID_ERROR_MOTOR_ADAPTOR    =    0x02D,    //    ErrorMotorAdaptor:  bits0-63: code; 
    CAN_ID_ERROR_ACCESSORY1    =    0x02E,    //    ErrorAccessory1:  bits0-63: code; 
    CAN_ID_ERROR_ACCESSORY2    =    0x02F,    //    ErrorAccessory2:  bits0-63: code; 
    ...
    CAN_ID_FRONT_WHEEL_CNT    =    0x03C,    //    frontWheelCnt:  bits0-31: right_count; bits32-63: left_count; 
    CAN_ID_REAR_WHEEL_CNT    =    0x03D,    //    rearWheelCnt:  bits0-31: right_count; bits32-63: left_count; 
    ...
    CAN_ID_ERROR_FRONT_WHEEL_SPEED    =    0x080,    //    ErrorFrontWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; 
    CAN_ID_ERROR_REAR_WHEEL_SPEED    =    0x081,    //    ErrorRearWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; 
    ...
    CAN_ID_OBSTACLE_DANGER_ZONE    =    0x122,    //    ObstacleDangerZoneMsg:  bits0-12: distance; bits13-20: timeToCollision; bits21-39: reserved; bits40-63: timeStamp; 
    ...
    CAN_ID_LOC_MANUAL    =    0x185,    //    LocManualMsg:  bits0-15: frontSteerAngle; bits16-23: slide; bits24-31: pressure; bit32: start; bit33: reverse; bits34-35: reserved; bit36: brake; bit37: EPB; bits38-39: reserved1; bits40-55: rearSteerAngle; 
    CAN_ID_LOC_JOYSTICK    =    0x186,    //    LocJoystickMsg:  bits0-9: x; bits10-19: y; bits20-23: hatswitch; bits24-31: rotation; bits32-39: throttle; bit40: b1; bit41: b2; bit42: b3; bit43: b4; bit44: b5; bit45: b6; bit46: b7; bit47: b8; bit48: b9; bit49: b10; bit50: b11; bit51: b12; 
    ...
    CAN_ID_FUSION_FRONT_LONG    =    0x21A,    //    FusionFrontLongitude:  bits0-35: longitude; bits36-49: forwardConf; bits50-61: heading; bits62-63: sync; 
    ...
    CAN_ID_FUSION_HEIGHT    =    0x21D,    //    FusionHeight:  bits0-15: height; bits16-27: speed; bits28-29: reserved; bits30-31: sync; 
    ...
    CAN_ID_IMU_ROT    =    0x261,    //    IMURot:  bits0-15: pitch; bits16-31: roll; bits32-47: heading; bits48-59: accuracy; bits60-61: status; bits62-63: sync; 
    CAN_ID_IMU_ACC    =    0x262,    //    IMUAcc:  bits0-15: x; bits16-31: y; bits32-47: z; bits48-49: status; bits50-61: reserved; bits62-63: sync; 
    CAN_ID_IMU_GYR    =    0x263,    //    IMUGyr:  bits0-15: x; bits16-31: y; bits32-47: z; bits48-55: temperature; bits56-57: status; bits58-61: unused; bits62-63: sync; 
    ...
    CAN_ID_DEVIATION_REQ    =    0x2C5,    //    DeviationReqMsg:  bits0-15: waypoint; bits16-23: offset; bits24-31: speed; bit32: InFlag; bits33-35: acceleration; bit36: OffsetActive; bit37: NoDeviation; 
    CAN_ID_DYNAMIC_TRACK_VALIDATION    =    0x300,    //    DynamicTrackValidationMsg:  bits0-15: waypoint; bits16-35: x; bits36-55: y; 
    ...
    CAN_ID_STOP_REQ    =    0x326,    //    StopReqMsg:  bits0-15: waypoint; bits16-23: decelerate; bit24: deceFlag; bits25-27: reserved; bits28-31: reason; 
    ...
    CAN_ID_REMOTE_SIGNAL    =    0x590,    //    RemoteSignalMsg:  bits0-15: id; bit16: startBtn; bit17: emergencyBtn; bit18: horn; 
    ...
    CAN_ID_IMU_MAG    =    0x727,    //    IMUMag:  bits0-15: x; bits16-31: y; bits32-47: z; bits48-49: status; bits50-61: unused; bits62-63: sync; 
    ...
    CAN_ID_FUSION_EXCEPTION    =    0x765,    //    fusionExceptionMsg:  bits0-31: ex_code; bits32-36: ex_addr; bits37-39: reserved; bits40-47: user_flag; 
    ...
    CAN_ID_FRONT_WHEEL_EXCEPTION    =    0x7C0,    //    frontWheelExceptionMsg:  bits0-31: ex_code; bits32-36: ex_addr; bits37-39: reserved; bits40-47: user_flag; 
    CAN_ID_REAR_WHEEL_EXCEPTION    =    0x7C1,    //    rearWheelExceptionMsg:  bits0-31: ex_code; bits32-36: ex_addr; bits37-39: reserved; bits40-47: user_flag; 
...
// Anywhere in your code using this enum put 
// static_assert(0x8D == NUMBER_OF_PARAMETER_ID, "PARAMETER ID changed"); // for C++
// _static_assert(0x8D == NUMBER_OF_PARAMETER_ID, "PARAMETER ID changed"); // for C
// this will trigger an error if this enum changes so that you can verify that your code is still valid with this change.
typedef enum
{
    PARAMETER_POST_PROC_HEADING_FILTER_LENGTH    =    0x01,
    PARAMETER_LOCATION_FILTER_LENGTH    =    0x02,
    PARAMETER_DISTANCE_BETWEEN_WAYPOINTS    =    0x03,
    PARAMETER_SPEED_INC_STEP    =    0x04,
...
// Anywhere in your code using this enum put 
// static_assert(0x04 == NUMBER_OF_STOP_REASON, "STOP REASON changed"); // for C++
// _static_assert(0x04 == NUMBER_OF_STOP_REASON, "STOP REASON changed"); // for C
// this will trigger an error if this enum changes so that you can verify that your code is still valid with this change.
typedef enum
{
    STOP_UNKNOW_STOP    =    0x00,
    STOP_USER_STOP    =    0x01,
    STOP_BUS_STOP    =    0x02,
    STOP_MANUAL_STOP    =    0x03,
