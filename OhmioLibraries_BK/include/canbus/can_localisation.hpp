...
//! Cretae a CAN message from latitude information 
//
...
can_msgs::Frame constructLatMsg(uint32_t can_id, double lat_or_long, uint64_t timestamp, uint8_t quality)
{
