...
bool observation_update(
      ...
      bool * innovation_covariance_PSD                   //!< OUTPUT - A flag indicating that innovation covariance is/isn't positive semi-definite. Filter will work, but a fals means only the diagonal non zero variances are being used
      );
