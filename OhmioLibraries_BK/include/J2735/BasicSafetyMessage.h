 ...
 * 	found in "/media/gadi/Data/UnderGit/ohmioSoftware/v2x/J2735_201603DA.ASN"
 * 	`asn1c -D /media/gadi/Data/UnderGit/ohmioSoftware/v2x/J2735 -fcompound-names -pdu=auto`
 */
...
typedef struct BasicSafetyMessage {
	...
	struct BasicSafetyMessage__partII {
		A_SEQUENCE_OF(struct PartIIcontent_151P0) list;
