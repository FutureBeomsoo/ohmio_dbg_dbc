...
- 비교 A: `OhmioLibraries_36` - `OhmioLibraries_36/include/canbus/dbc_MsgID_main.h`
...
| ------------ | ----------------- | ----------------- |
| Line         | 899               | 862               |
| SHA256       | 2037a55d2fd0      | db26235e4f68      |
| Struct       | 0                 | 0                 |
| Enum         | 32                | 31                |
| CAN_ID       | 270               | 256               |
| Function     | 0                 | 0                 |
...
### 전처리/Include 비교
Macro 값 변경:
| Macro                     | OhmioLibraries_36 | OhmioLibraries_BK |
| ------------------------- | ----------------- | ----------------- |
| MAIN_CANBUS_VERSION_BUILD | 0xE3A942C4        | 0x47AB1E0D        |
| MAIN_CANBUS_VERSION_MAJOR | 4                 | 2                 |
| MAIN_CANBUS_VERSION_MINOR | 9                 | 110               |


### CAN ID enum 비교
OhmioLibraries_36에만 있는 CAN_ID:
| Name                             | Value | Comment                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| -------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
동일 CAN_ID 이름의 값 변경:
| Name           | OhmioLibraries_36 | OhmioLibraries_BK |
| -------------- | ----------------- | ----------------- |
...
| Value | OhmioLibraries_36    | OhmioLibraries_BK          |
| ----- | -------------------- | -------------------------- |
...
#### CAN_ID_DEVIATION_REQ (0x2C5)
  - OhmioLibraries_36: DeviationReqMsg:
...
#### CAN_ID_DYNAMIC_TRACK_VALIDATION (0x300)
  - OhmioLibraries_36: DynamicTrackValidationMsg:
  - OhmioLibraries_BK: DynamicTrackValidationMsg:  bits0-15: waypoint; bits16-35: x; bits36-55: y;
#### CAN_ID_ERROR_ACCESSORY1 (0x2E)
  - OhmioLibraries_36: ErrorAccessory1:  bit0: AccessoryIncorrectPCB; bit1: AccessoryNonUniqueID; bit2:
                       AccessoryRelayOpen; bit3: AccessoryDrvInfoComms;
  - OhmioLibraries_BK: ErrorAccessory1:  bits0-63: code;
#### CAN_ID_ERROR_ACCESSORY2 (0x2F)
  - OhmioLibraries_36: ErrorAccessory2:  bit0: AccessoryIncorrectPCB; bit1: AccessoryNonUniqueID; bit2:
                       AccessoryRelayOpen; bit3: AccessoryDrvInfoComms;
  - OhmioLibraries_BK: ErrorAccessory2:  bits0-63: code;
#### CAN_ID_ERROR_DRIVE_EXT (0x24)
  - OhmioLibraries_36: ErrorDriveExt:  bit0: DrvextObsValidationCommsError; bit1: DrvextMotorNoResp; bit2:
                       DrvextSafetyRelayOpen; bit3: DrvextParameterOutOfRange; bit4: DrvextMotorOverTemp; bit5:
                       DrvextSpeedDeviationError;
...
#### CAN_ID_ERROR_FRONT_WHEEL_SPEED (0x80)
  - OhmioLibraries_36: ErrorFrontWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; bit2:
...
#### CAN_ID_ERROR_FUSION_DEBUG (0x725)
  - OhmioLibraries_36: ErrorFusionDebugMsg:  bit0: fusdebugReset; bit1: initialisation; bit2: steerAngleFrontInvalid;
                       bit3: steerAngleRearInvalid; bit4: wheelSpeedInvalid; bit5: timeStepSizeInvalid; bit6:
                       huge_sensor_update; bits7-8: reserved; bit9: speedNotAvailableButNotZero; bit10:
                       ...
                       bit16: drive_info_comms; bits17-31: reserved1; bit32: cholesky_failed_veh; bit33:
                       innovation_covariance_not_psd_veh; bit34: choleskey_failed_odo; bit35:
                       innovation_convariance_not_psd_odo; bit36: steer_angle_front_unavailable; bit37:
                       steer_angle_rear_unavailable; bit38: rtk_front_no_data_ubx; bit39: rtk_rear_no_data_ubx; bit40:
                       rtk_front_no_data_can; bit41: rtk_rear_no_data_can; bit42: dead_reckoning; bit43:
                       odometry_suspicious; bit44: reserved2; bit45: gnss_antennas_out_of_range; bit46:
                       using_lidar_slam; bit47: using_gps; bit48: fusion_initialisable;
...
#### CAN_ID_ERROR_REAR_WHEEL_SPEED (0x81)
  - OhmioLibraries_36: ErrorRearWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; bit2:
                       wheel_drv_info_comms_error;
...
#### CAN_ID_FRONT_WHEEL_CNT (0x3C)
  - OhmioLibraries_36: frontWheelCnt:  bits0-15: right_count; bits16-31: left_count; bits32-63: clock;
  - OhmioLibraries_BK: frontWheelCnt:  bits0-31: right_count; bits32-63: left_count;
#### CAN_ID_FRONT_WHEEL_EXCEPTION (0x7C0)
  - OhmioLibraries_36: frontWheelExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_FUSION_EXCEPTION (0x765)
  - OhmioLibraries_36: fusionExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_FUSION_FLAGS (0x724)
  - OhmioLibraries_36: FusionFlagsMsg:  bit0: fus_internal_reset; bit1: init_failed; bit2: front_steer_invalid; bit3:
                       ...
                       huge_sensor_update; bit25: safety_relay_open; bit26: drv_info_comms_error; bit27:
                       w_front_gnss_no_data_ubx; bit28: w_rear_gnss_no_data; bit29: w_odometry_suspicious; bit30:
                       w_gnss_antennas_out_of_range; bit31: w_no_gnss_period_estimate; bit32: w_front_gnss_comms; bit33:
                       w_rear_gnss_comms; bit34: no_engine_state; bits35-39: reserved; bit40: st_lidar_slam_no_data_can;
                       bit41: st_lidar_slam_no_kf; bit42: st_cam_slam_no_data_can; bit43: st_cam_slam_no_kf; bits44-45:
                       reserved1; bit46: st_using_front_gnss; bit47: st_using_rear_gnss; bit48: st_using_lidar_slam;
                       bit49: st_using_cam_slam; bit50: st_using_imu_heading; bit51: reserved2; bit52:
                       st_dead_reckoning; bits53-54: reserved3; bit55: st_external_reset;
...
#### CAN_ID_FUSION_FRONT_LONG (0x21A)
  - OhmioLibraries_36: FusionFrontLongitude:
...
#### CAN_ID_FUSION_HEIGHT (0x21D)
  - OhmioLibraries_36: FusionHeight:  bits0-22: height; bits23-34: speed; bits35-36: sync; bits37-46: delay_gnss_front;
                       bits47-56: delay_gnss_rear;
  - OhmioLibraries_BK: FusionHeight:  bits0-15: height; bits16-27: speed; bits28-29: reserved; bits30-31: sync;
#### CAN_ID_FUS_ERROR (0x25)
  - OhmioLibraries_36: FusError:  bit0: fus_internal_reset; bit1: fus_init_failed; bit2: fus_front_steer_invalid; bit3:
                       ...
                       bit23: fus_saved_antenna_offset_missing; bit24: fus_huge_sensor_update; bit25:
                       fus_safety_relay_open; bit26: fus_drv_info_comms_error;
...
#### CAN_ID_IMU_MAG (0x727)
  - OhmioLibraries_36: IMUMag:  bits0-19: x; bits20-39: y; bits40-59: z; bits60-61: reserved; bits62-63: sync;
  - OhmioLibraries_BK: IMUMag:  bits0-15: x; bits16-31: y; bits32-47: z; bits48-49: status; bits50-61: unused;
                       bits62-63: sync;
#### CAN_ID_LOC_JOYSTICK (0x186)
  - OhmioLibraries_36: LocJoystickMsg:  bits0-9: x; bits10-19: y; bits20-23: hatswitch; bits24-31: rotation; bits32-39:
...
#### CAN_ID_LOC_MANUAL (0x185)
  - OhmioLibraries_36: LocManualMsg:  bits0-15: frontSteerAngle; bits16-23: slide; bits24-31: pressure; bit32: start;
...
#### CAN_ID_MANAGEMENT_ERROR (0x2B)
  - OhmioLibraries_36: ManagementError:  bit0: monitorError; bit1: mgtStatusError; bit2: mgtDrvInfoCommsError; bit3:
...
#### CAN_ID_OBSTACLE_DANGER_ZONE (0x122)
  - OhmioLibraries_36: ObstacleDangerZoneMsg:  bits0-12: distance; bits13-20: timeToCollision; bit21: notMoving; bit22:
...
#### CAN_ID_OBSTACLE_TRACK_DISTANCE (0x123)
  - OhmioLibraries_36: ObstacleTrackDistanceMsg:  bits0-12: trackDistance; bits13-25: sideDistanceA; bits26-38:
                       sideDistanceB; bit39: moveAwayFlag; bit40: incSpeedFlag; bit41: ignoredObstacle; bit42:
                       ClearOnRight; bit43: ClearOnLeft;
...
#### CAN_ID_REAR_WHEEL_CNT (0x3D)
  - OhmioLibraries_36: rearWheelCnt:  bits0-15: right_count; bits16-31: left_count; bits32-63: clock;
  - OhmioLibraries_BK: rearWheelCnt:  bits0-31: right_count; bits32-63: left_count;
#### CAN_ID_REAR_WHEEL_EXCEPTION (0x7C1)
  - OhmioLibraries_36: rearWheelExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_REMOTE_SIGNAL (0x590)
  - OhmioLibraries_36: RemoteSignalMsg:  bits0-15: id; bit16: startBtn; bit17: emergencyBtn; bit18: horn; bit19:
                       overtake;
  - OhmioLibraries_BK: RemoteSignalMsg:  bits0-15: id; bit16: startBtn; bit17: emergencyBtn; bit18: horn;
#### CAN_ID_STARTUP_ERROR (0x23)
  - OhmioLibraries_36: StartupErrorMsg:  bit0: startupVersionError; bit1: bmsStatus; bit2: bmsErrLevel; bit3:
...
## 사용자 점검 후보
- MAIN_CANBUS_VERSION_BUILD 버전 값 변경: 0xE3A942C4 -> 0x47AB1E0D
- MAIN_CANBUS_VERSION_MAJOR 버전 값 변경: 4 -> 2
- MAIN_CANBUS_VERSION_MINOR 버전 값 변경: 9 -> 110
