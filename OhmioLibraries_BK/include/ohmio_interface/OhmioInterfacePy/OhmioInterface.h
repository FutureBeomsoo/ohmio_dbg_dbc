...
// --------------------- drive control -----------------------------------------------
	...
	py::enum_<SYS_STATES>(m, "ModeState")
		...
		.value("dump_log", SYS_STATES::SYS_DUMP_LOG)
		.value("dump_record", SYS_STATES::SYS_DUMP_REC)
		.value("load_path", SYS_STATES::SYS_LOAD)
		.value("manual_remote", SYS_STATES::SYS_REMOTE)
		.value("postprocess_new_track", SYS_STATES::SYS_POST_PROC)
		...
		.value("battery_charging", SYS_STATES::SYS_CHARGE)
		.value("steering_calibration", SYS_STATES::SYS_CALIBRATION)
		.value("select", SYS_STATES::SYS_SELECT)
		.value("validate_track", SYS_STATES::SYS_VALIDATE_OB)
		.value("wait_transmition", SYS_STATES::SYS_WAIT_TRANS)
...
// --------------------- Obstacle interface -----------------------------------------------
	py::class_<OhmioInterfacePy::ObstacleInterface>(m, "ObstacleInterface")
		.def(py::init<OhmioInterfacePy::InterfaceManager&>())
		.def("get_lidar_obstacle_data", &OhmioInterfacePy::ObstacleInterface::GetLidarData)
		.def("set_static_obstacle", &OhmioInterfacePy::ObstacleInterface::SetStaticObstacle)
		.def("clear_static_obstacle", &OhmioInterfacePy::ObstacleInterface::ClearStaticObstacle)
		.def("get_static_obstacles", &OhmioInterfacePy::ObstacleInterface::GetStaticObstacles);
