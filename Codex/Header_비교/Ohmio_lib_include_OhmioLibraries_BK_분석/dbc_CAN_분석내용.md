...
- 비교 A: `Ohmio_lib_include` - `OhmioLibraries_36/Ohmio_lib_include/include/canbus/dbc_CAN.h`
...
#### EPBErrorMsg_t
- Signal 총 bit 수 변경: Ohmio_lib_include=5, OhmioLibraries_BK=4
Ohmio_lib_include에만 있는 Signal:
| Signal               | 정의                                   | OhmioLibraries_BK 겹침 영역 |
| -------------------- | ------------------------------------ | ----------------------- |
...
#### ErrorAccessory_t
- Signal 총 bit 수 변경: Ohmio_lib_include=4, OhmioLibraries_BK=64
Ohmio_lib_include에만 있는 Signal:
| Signal                | 정의                                                  | OhmioLibraries_BK 겹침 영역   |
| --------------------- | --------------------------------------------------- | ------------------------- |
...
#### ErrorDriveExt_t
- Signal 총 bit 수 변경: Ohmio_lib_include=6, OhmioLibraries_BK=3
Ohmio_lib_include에만 있는 Signal:
| Signal                    | 정의                                        | OhmioLibraries_BK 겹침 영역 |
| ------------------------- | ----------------------------------------- | ----------------------- |
...
#### ErrorFootMsg_t
- Signal 총 bit 수 변경: Ohmio_lib_include=9, OhmioLibraries_BK=8
Ohmio_lib_include에만 있는 Signal:
| Signal                | 정의                                    | OhmioLibraries_BK 겹침 영역 |
| --------------------- | ------------------------------------- | ----------------------- |
...
- Signal 총 bit 수 변경: Ohmio_lib_include=49, OhmioLibraries_BK=50
동일 Signal 이름의 정의 변경:
...
Reserved 대체 후보:
| 범위    | Ohmio_lib_include                 | OhmioLibraries_BK              | 판정                                         |
| ----- | --------------------------------- | ------------------------------ | ------------------------------------------ |
| bit7  | bits7-8 uint64_t reserved:2       | bit7 uint64_t rtkFrontNull:1   | Reserved 대체 후보: Ohmio_lib_include reserved |
| bit8  | bits7-8 uint64_t reserved:2       | bit8 uint64_t rtkRearNull:1    | Reserved 대체 후보: Ohmio_lib_include reserved |
...
#### ErrorFusion_t
- Signal 총 bit 수 변경: Ohmio_lib_include=26, OhmioLibraries_BK=24
Ohmio_lib_include에만 있는 Signal:
| Signal                  | 정의                                       | OhmioLibraries_BK 겹침 영역 |
| ----------------------- | ---------------------------------------- | ----------------------- |
...
#### ErrorManual_t
- message ID 주석 변경: Ohmio_lib_include=0x14 ManualError, 0x26 Trans1Error, OhmioLibraries_BK=0x14 ErrorManual
- Signal 총 bit 수 변경: Ohmio_lib_include=6, OhmioLibraries_BK=4
Ohmio_lib_include에만 있는 Signal:
| Signal                  | 정의                                      | OhmioLibraries_BK 겹침 영역 |
| ----------------------- | --------------------------------------- | ----------------------- |
...
#### ErrorObstaclePC_t
- Signal 총 bit 수 변경: Ohmio_lib_include=25, OhmioLibraries_BK=24
Ohmio_lib_include에만 있는 Signal:
| Signal                        | 정의                                             | OhmioLibraries_BK 겹침 영역 |
| ----------------------------- | ---------------------------------------------- | ----------------------- |
...
#### ErrorReportMsg_t
- raw buffer 크기 변경: Ohmio_lib_include=6, OhmioLibraries_BK=8
#### ErrorWheelSpeed_t
- Signal 총 bit 수 변경: Ohmio_lib_include=3, OhmioLibraries_BK=2
Ohmio_lib_include에만 있는 Signal:
| Signal                     | 정의                                         | OhmioLibraries_BK 겹침 영역 |
| -------------------------- | ------------------------------------------ | ----------------------- |
...
#### FusError_t
- Signal 총 bit 수 변경: Ohmio_lib_include=27, OhmioLibraries_BK=25
동일 Signal 이름의 정의 변경:
| Signal                | Ohmio_lib_include                      | OhmioLibraries_BK                      | 판정               |
| --------------------- | -------------------------------------- | -------------------------------------- | ---------------- |
...
#### FusionFlagsMsg_t
- Signal 총 bit 수 변경: Ohmio_lib_include=56, OhmioLibraries_BK=54
동일 Signal 이름의 정의 변경:
| Signal            | Ohmio_lib_include                  | OhmioLibraries_BK                  | 판정               |
| ----------------- | ---------------------------------- | ---------------------------------- | ---------------- |
...
| bit44 | bits44-45 uint64_t reserved1:2        | bit44 uint64_t st_front_gnss_no_data_can:1 | Reserved 대체 후보: Ohmio_lib_include reserved |
| bit45 | bits44-45 uint64_t reserved1:2        | bit45 uint64_t st_rear_gnss_no_data_can:1  | Reserved 대체 후보: Ohmio_lib_include reserved |
| bit53 | bits53-54 uint64_t reserved3:2        | bit53 uint64_t st_external_reset:1         | Reserved 대체 후보: Ohmio_lib_include reserved |
...
#### FusionHeight_t
- raw buffer 크기 변경: Ohmio_lib_include=8, OhmioLibraries_BK=4
- Signal 총 bit 수 변경: Ohmio_lib_include=57, OhmioLibraries_BK=32
동일 Signal 이름의 정의 변경:
| Signal | Ohmio_lib_include                  | OhmioLibraries_BK                  | 판정               |
| ------ | ---------------------------------- | ---------------------------------- | ---------------- |
...
#### IMUAcc_t
- message ID 주석 변경: Ohmio_lib_include=0x622 IMUAcc, OhmioLibraries_BK=0x262 IMUAcc
#### IMUGyr_t
- message ID 주석 변경: Ohmio_lib_include=0x623 IMUGyr, OhmioLibraries_BK=0x263 IMUGyr
#### IMUMag_t
동일 Signal 이름의 정의 변경:
| Signal | Ohmio_lib_include             | OhmioLibraries_BK             | 판정               |
| ------ | ----------------------------- | ----------------------------- | ---------------- |
...
#### IMURot_t
- message ID 주석 변경: Ohmio_lib_include=0x621 IMURot, OhmioLibraries_BK=0x261 IMURot
#### JoystickMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x181 JoystickMsg, 0x186 LocJoystickMsg, OhmioLibraries_BK=0x181 JoystickMsg, 0x183 TeleOpMsg, 0x186 LocJoystickMsg, 0x188 TransJoystickMsg
- Signal 총 bit 수 변경: Ohmio_lib_include=64, OhmioLibraries_BK=52
Ohmio_lib_include에만 있는 Signal:
| Signal   | 정의                            | OhmioLibraries_BK 겹침 영역 |
| -------- | ----------------------------- | ----------------------- |
...
#### LidarSpeed_t
- Signal 총 bit 수 변경: Ohmio_lib_include=62, OhmioLibraries_BK=57
Ohmio_lib_include에만 있는 Signal:
| Signal | 정의                                  | OhmioLibraries_BK 겹침 영역 |
| ------ | ----------------------------------- | ----------------------- |
...
#### LongitudeMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x211 FusionLongitudeFront, 0x214 FusionLongitudeRear, 0x7F3 EmulatorLongitude, OhmioLibraries_BK=0x211 FusionLongitudeFront, 0x214 FusionLongitudeRear, 0x221 longitudeFrontMsg, 0x231 longitudeBackMsg
#### ManagementError_t
- Signal 총 bit 수 변경: Ohmio_lib_include=26, OhmioLibraries_BK=18
동일 Signal 이름의 정의 변경:
| Signal   | Ohmio_lib_include           | OhmioLibraries_BK           | 판정               |
| -------- | --------------------------- | --------------------------- | ---------------- |
...
#### ManualDriveMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x180 ManualDriveMsg, 0x185 LocManualMsg, OhmioLibraries_BK=0x180 ManualDriveMsg, 0x185 LocManualMsg, 0x187 TransDriveMsg
- Signal 총 bit 수 변경: Ohmio_lib_include=64, OhmioLibraries_BK=56
Ohmio_lib_include에만 있는 Signal:
| Signal | 정의                      | OhmioLibraries_BK 겹침 영역 |
| ------ | ----------------------- | ----------------------- |
| id     | bits56-63 uint64_t id:8 | -                       |
...
- Signal 총 bit 수 변경: Ohmio_lib_include=44, OhmioLibraries_BK=42
Ohmio_lib_include에만 있는 Signal:
| Signal       | 정의                                     | OhmioLibraries_BK 겹침 영역 |
| ------------ | -------------------------------------- | ----------------------- |
...
#### RemoteSignalMsg_t
- Signal 총 bit 수 변경: Ohmio_lib_include=20, OhmioLibraries_BK=19
Ohmio_lib_include에만 있는 Signal:
| Signal   | 정의                        | OhmioLibraries_BK 겹침 영역 |
| -------- | ------------------------- | ----------------------- |
...
#### StartupErrorMsg_t
- Signal 총 bit 수 변경: Ohmio_lib_include=7, OhmioLibraries_BK=5
Ohmio_lib_include에만 있는 Signal:
| Signal                | 정의                                    | OhmioLibraries_BK 겹침 영역 |
| --------------------- | ------------------------------------- | ----------------------- |
...
| 범위        | Ohmio_lib_include               | OhmioLibraries_BK                          | 판정                                         |
| --------- | ------------------------------- | ------------------------------------------ | ------------------------------------------ |
| bits6-7   | bits6-7 uint64_t reserved:2     | bits0-7 uint64_t mode:8                    | Reserved 대체 후보: Ohmio_lib_include reserved |
| bits32-39 | bits32-59 uint64_t reserved1:28 | bits32-39 uint64_t brakePressure:8, // bar | Reserved 대체 후보: Ohmio_lib_include reserved |
...
#### TrackAckMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x651 TrackAckManageMsg, 0x661 TrackAckDriveMsg, OhmioLibraries_BK=0x651 TrackAckManageMsg, 0x661 TrackAckDriveMsg, 0x671 TrackAckObsMsg
#### TrackCtrlMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x650 TrackCtrlManageMsg, 0x660 TrackCtrlDriveMsg, OhmioLibraries_BK=0x650 TrackCtrlManageMsg, 0x660 TrackCtrlDriveMsg, 0x670 TrackCtrlObsMsg
#### TrackDataMsg_t
- message ID 주석 변경: Ohmio_lib_include=0x652 TrackDataManageMsg, 0x662 TrackDataDriveMsg, OhmioLibraries_BK=0x652 TrackDataManageMsg, 0x662 TrackDataDriveMsg, 0x672 TrackDataObsMsg
#### WheelCountMsg_t
동일 Signal 이름의 정의 변경:
| Signal      | Ohmio_lib_include                | OhmioLibraries_BK                | 판정               |
| ----------- | -------------------------------- | -------------------------------- | ---------------- |
