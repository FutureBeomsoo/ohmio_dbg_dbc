...
namespace OhmioModel
{
	...
	{
	public:
		MockWpFlagsSource() : m_f1(0), m_f2(0), validEvents(true), m_driveMode(0), wpIdx(0){}
		~MockWpFlagsSource() {}
		...
		virtual bool GetWpLocation(int wpIdx, double& latitude, double& longitude, double& heading) override
		{
			return false;
		}
