...
#define PERIPHERAL_CANBUS_VERSION_MAJOR 2
#define PERIPHERAL_CANBUS_VERSION_MINOR 3
#define PERIPHERAL_CANBUS_VERSION_BUILD 0xD1134632         // 32 bit hash code for the dbc file
...
typedef enum
{
    ...
    CAN_ID_BMS_STATUS8    =    0x1089F5F4,    //    BMSStatusMsg8:  bits0-7: totalPacketFrames; bits8-15: packetSeqNum; bits16-23: cellSamplingTemp; bits24-31: cellSamplingTemp2; bits32-39: cellSamplingTemp3; bits40-47: cellSamplingTemp4; bits48-55: cellSamplingTemp5; bits56-63: cellSamplingTemp6; 
    ...
    CAN_ID_AIR_CON_REQ    =    0x18FF45F4,    //    AirConReqMsg:  bits0-1: mode; bits2-3: level; bits4-7: temperature; bits8-15: roofLight; bits16-18: JJK161Level; 
...
// the set of AIRCON ERROR 
// Anywhere in your code using this enum put 
// static_assert(0x07 == NUMBER_OF_AIRCON_ERROR, "AIRCON ERROR changed"); // for C++
// _static_assert(0x07 == NUMBER_OF_AIRCON_ERROR, "AIRCON ERROR changed"); // for C
// this will trigger an error if this enum changes so that you can verify that your code is still valid with this change.
typedef enum
{
    AIRCON_NO_ERROR    =    0x00,
    AIRCON_ROOM_TEMP_SENSOR    =    0x01,
    AIRCON_TEMP_SENSOR1    =    0x02,
    AIRCON_TEMP_SENSOR2    =    0x03,
    AIRCON_OUTDOOR_TEAMP_SENSOR    =    0x04,
    AIRCON_PRESSURE1    =    0x05,
    AIRCON_PRESSURE2    =    0x06,

    /* number of mode in total */
    NUMBER_OF_AIRCON_ERROR,
} AIRCON_ERROR;
...
// the set of BMS CHARGE CURRENT 
// Anywhere in your code using this enum put 
// static_assert(0x06 == NUMBER_OF_BMS_CHARGE_CURRENT, "BMS CHARGE CURRENT changed"); // for C++
// _static_assert(0x06 == NUMBER_OF_BMS_CHARGE_CURRENT, "BMS CHARGE CURRENT changed"); // for C
// this will trigger an error if this enum changes so that you can verify that your code is still valid with this change.
typedef enum
{
    BMS_Charge_Reserved    =    0x00,
    BMS_Charge_2kw    =    0x01,
    BMS_Charge_3kw    =    0x02,
    BMS_Charge_4kw    =    0x03,
    BMS_Charge_5kw    =    0x04,
