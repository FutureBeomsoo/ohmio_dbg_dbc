...
| ------------ | -------------- | ----------------- |
| Line         | 3661           | 4787              |
| SHA256       | 1f61bb3507a1   | e1d368cabda6      |
| Struct       | 146            | 152               |
| Enum         | 28             | 25                |
| CAN_ID       | 0              | 0                 |
| Function     | 130            | 146               |
| Unified diff | -1559          | +2685             |
...
| ObstaclePcWarning_t         | 0x707 ObstaclePcWarning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 18    |
...
비트 범위 충돌:
| 겹침   | OhmioLibraries                      | OhmioLibraries_BK                        | 판정                             |
| ---- | ----------------------------------- | ---------------------------------------- | ------------------------------ |
...
#### EPBErrorMsg_t
- Signal 총 bit 수 변경: OhmioLibraries=5, OhmioLibraries_BK=4
OhmioLibraries에만 있는 Signal:
| Signal               | 정의                                   | OhmioLibraries_BK 겹침 영역 |
| -------------------- | ------------------------------------ | ----------------------- |
...
#### ErrorAccessory_t
- Signal 총 bit 수 변경: OhmioLibraries=4, OhmioLibraries_BK=64
OhmioLibraries에만 있는 Signal:
| Signal                | 정의                                                  | OhmioLibraries_BK 겹침 영역   |
| --------------------- | --------------------------------------------------- | ------------------------- |
...
#### ErrorDriveExt_t
- Signal 총 bit 수 변경: OhmioLibraries=8, OhmioLibraries_BK=3
OhmioLibraries에만 있는 Signal:
| Signal                    | 정의                                        | OhmioLibraries_BK 겹침 영역 |
| ------------------------- | ----------------------------------------- | ----------------------- |
...
#### ErrorFootMsg_t
- Signal 총 bit 수 변경: OhmioLibraries=9, OhmioLibraries_BK=8
OhmioLibraries에만 있는 Signal:
| Signal                | 정의                                    | OhmioLibraries_BK 겹침 영역 |
| --------------------- | ------------------------------------- | ----------------------- |
...
- Signal 총 bit 수 변경: OhmioLibraries=49, OhmioLibraries_BK=50
동일 Signal 이름의 정의 변경:
| Signal    | OhmioLibraries                  | OhmioLibraries_BK              | 판정               |
| --------- | ------------------------------- | ------------------------------ | ---------------- |
...
Reserved 대체 후보:
| 범위    | OhmioLibraries                    | OhmioLibraries_BK              | 판정                                         |
| ----- | --------------------------------- | ------------------------------ | ------------------------------------------ |
| bit7  | bits7-8 uint64_t reserved:2       | bit7 uint64_t rtkFrontNull:1   | Reserved 대체 후보: OhmioLibraries reserved    |
| bit8  | bits7-8 uint64_t reserved:2       | bit8 uint64_t rtkRearNull:1    | Reserved 대체 후보: OhmioLibraries reserved    |
...
#### ErrorFusion_t
- Signal 총 bit 수 변경: OhmioLibraries=26, OhmioLibraries_BK=24
OhmioLibraries에만 있는 Signal:
| Signal                  | 정의                                       | OhmioLibraries_BK 겹침 영역 |
| ----------------------- | ---------------------------------------- | ----------------------- |
...
#### ErrorManual_t
- message ID 주석 변경: OhmioLibraries=0x14 ManualError, 0x26 Trans1Error, OhmioLibraries_BK=0x14 ErrorManual
- Signal 총 bit 수 변경: OhmioLibraries=6, OhmioLibraries_BK=4
OhmioLibraries에만 있는 Signal:
| Signal                  | 정의                                      | OhmioLibraries_BK 겹침 영역 |
| ----------------------- | --------------------------------------- | ----------------------- |
...
#### ErrorObstaclePC_t
- Signal 총 bit 수 변경: OhmioLibraries=25, OhmioLibraries_BK=24
OhmioLibraries에만 있는 Signal:
| Signal                        | 정의                                             | OhmioLibraries_BK 겹침 영역 |
| ----------------------------- | ---------------------------------------------- | ----------------------- |
...
#### ErrorReportMsg_t
- raw buffer 크기 변경: OhmioLibraries=6, OhmioLibraries_BK=8
#### ErrorWheelSpeed_t
- Signal 총 bit 수 변경: OhmioLibraries=3, OhmioLibraries_BK=2
OhmioLibraries에만 있는 Signal:
| Signal                     | 정의                                         | OhmioLibraries_BK 겹침 영역 |
| -------------------------- | ------------------------------------------ | ----------------------- |
...
#### FusError_t
- Signal 총 bit 수 변경: OhmioLibraries=27, OhmioLibraries_BK=25
동일 Signal 이름의 정의 변경:
| Signal                | OhmioLibraries                         | OhmioLibraries_BK                      | 판정               |
| --------------------- | -------------------------------------- | -------------------------------------- | ---------------- |
...
#### FusionFlagsMsg_t
- Signal 총 bit 수 변경: OhmioLibraries=56, OhmioLibraries_BK=54
동일 Signal 이름의 정의 변경:
| Signal            | OhmioLibraries                     | OhmioLibraries_BK                  | 판정               |
| ----------------- | ---------------------------------- | ---------------------------------- | ---------------- |
| reserved          | bit22 uint64_t reserved:1          | bits25-26 uint64_t reserved:2      | bit/type/unit 변경 |
| reserved1         | bits37-39 uint64_t reserved1:3     | bits35-39 uint64_t reserved1:5     | bit/type/unit 변경 |
...
| reserved3            | bit51 uint64_t reserved3:1            | bit51 uint64_t reserved2:1            |
| reserved4            | bits53-54 uint64_t reserved4:2        | bit53 uint64_t st_external_reset:1    |
| st_using_imu_heading | bit50 uint64_t st_using_imu_heading:1 | bit50 uint64_t st_dead_reckoning:1    |
| w_large_gnss_delay   | bit35 uint64_t w_large_gnss_delay:1   | bits35-39 uint64_t reserved1:5        |
| w_large_lidar_delay  | bit36 uint64_t w_large_lidar_delay:1  | bits35-39 uint64_t reserved1:5        |
| w_no_engine_state    | bit34 uint64_t w_no_engine_state:1    | bit34 uint64_t w_huge_sensor_update:1 |

OhmioLibraries_BK에만 있는 Signal:
| Signal                    | 정의                                         | OhmioLibraries 겹침 영역               |
| ------------------------- | ------------------------------------------ | ---------------------------------- |
| conflicting_inputs        | bit22 uint64_t conflicting_inputs:1        | bit22 uint64_t reserved:1          |
| st_front_gnss_no_data_can | bit44 uint64_t st_front_gnss_no_data_can:1 | bits44-45 uint64_t reserved2:2     |
| st_rear_gnss_no_data_can  | bit45 uint64_t st_rear_gnss_no_data_can:1  | bits44-45 uint64_t reserved2:2     |
| st_recent_gnss_available  | bit52 uint64_t st_recent_gnss_available:1  | bit52 uint64_t st_dead_reckoning:1 |
| w_huge_sensor_update      | bit34 uint64_t w_huge_sensor_update:1      | bit34 uint64_t w_no_engine_state:1 |
...
| bit35 | bit35 uint64_t w_large_gnss_delay:1   | bits35-39 uint64_t reserved1:5             | Reserved 대체 후보: OhmioLibraries_BK reserved |
| bit36 | bit36 uint64_t w_large_lidar_delay:1  | bits35-39 uint64_t reserved1:5             | Reserved 대체 후보: OhmioLibraries_BK reserved |
| bit44 | bits44-45 uint64_t reserved2:2        | bit44 uint64_t st_front_gnss_no_data_can:1 | Reserved 대체 후보: OhmioLibraries reserved    |
| bit45 | bits44-45 uint64_t reserved2:2        | bit45 uint64_t st_rear_gnss_no_data_can:1  | Reserved 대체 후보: OhmioLibraries reserved    |
| bit53 | bits53-54 uint64_t reserved4:2        | bit53 uint64_t st_external_reset:1         | Reserved 대체 후보: OhmioLibraries reserved    |

비트 범위 충돌:
| 겹침    | OhmioLibraries                        | OhmioLibraries_BK                         | 판정                             |
| ----- | ------------------------------------- | ----------------------------------------- | ------------------------------ |
| bit24 | bit24 uint64_t huge_sensor_update:1   | bit24 uint64_t safety_relay_open:1        | 동일 bit 영역의 non-reserved 정의 불일치 |
| bit34 | bit34 uint64_t w_no_engine_state:1    | bit34 uint64_t w_huge_sensor_update:1     | 동일 bit 영역의 non-reserved 정의 불일치 |
...
#### FusionHeight_t
- raw buffer 크기 변경: OhmioLibraries=8, OhmioLibraries_BK=4
- Signal 총 bit 수 변경: OhmioLibraries=64, OhmioLibraries_BK=32
동일 Signal 이름의 정의 변경:
| Signal | OhmioLibraries                     | OhmioLibraries_BK                  | 판정               |
| ------ | ---------------------------------- | ---------------------------------- | ---------------- |
...
물리/편의 member 차이:
| member       | OhmioLibraries      | OhmioLibraries_BK |
| ------------ | ------------------- | ----------------- |
| compute_time | double compute_time | -                 |

#### IMUAcc_t
- message ID 주석 변경: OhmioLibraries=0x622 IMUAcc, OhmioLibraries_BK=0x262 IMUAcc
#### IMUGyr_t
- message ID 주석 변경: OhmioLibraries=0x623 IMUGyr, OhmioLibraries_BK=0x263 IMUGyr
#### IMUMag_t
동일 Signal 이름의 정의 변경:
| Signal | OhmioLibraries                | OhmioLibraries_BK             | 판정               |
| ------ | ----------------------------- | ----------------------------- | ---------------- |
...
#### IMURot_t
- message ID 주석 변경: OhmioLibraries=0x621 IMURot, OhmioLibraries_BK=0x261 IMURot
#### JoystickMsg_t
- message ID 주석 변경: OhmioLibraries=0x181 JoystickMsg, 0x186 LocJoystickMsg, OhmioLibraries_BK=0x181 JoystickMsg, 0x183 TeleOpMsg, 0x186 LocJoystickMsg, 0x188 TransJoystickMsg
- Signal 총 bit 수 변경: OhmioLibraries=64, OhmioLibraries_BK=52
OhmioLibraries에만 있는 Signal:
| Signal   | 정의                            | OhmioLibraries_BK 겹침 영역 |
| -------- | ----------------------------- | ----------------------- |
...
#### LidarSpeed_t
- Signal 총 bit 수 변경: OhmioLibraries=62, OhmioLibraries_BK=57
OhmioLibraries에만 있는 Signal:
| Signal | 정의                                  | OhmioLibraries_BK 겹침 영역 |
| ------ | ----------------------------------- | ----------------------- |
...
#### LongitudeMsg_t
- message ID 주석 변경: OhmioLibraries=0x211 FusionLongitudeFront, 0x214 FusionLongitudeRear, 0x7F3 EmulatorLongitude, OhmioLibraries_BK=0x211 FusionLongitudeFront, 0x214 FusionLongitudeRear, 0x221 longitudeFrontMsg, 0x231 longitudeBackMsg
#### ManagementError_t
- Signal 총 bit 수 변경: OhmioLibraries=26, OhmioLibraries_BK=18
동일 Signal 이름의 정의 변경:
| Signal   | OhmioLibraries              | OhmioLibraries_BK           | 판정               |
| -------- | --------------------------- | --------------------------- | ---------------- |
...
#### ManualDriveMsg_t
- message ID 주석 변경: OhmioLibraries=0x180 ManualDriveMsg, 0x185 LocManualMsg, OhmioLibraries_BK=0x180 ManualDriveMsg, 0x185 LocManualMsg, 0x187 TransDriveMsg
- Signal 총 bit 수 변경: OhmioLibraries=64, OhmioLibraries_BK=56
OhmioLibraries에만 있는 Signal:
| Signal | 정의                      | OhmioLibraries_BK 겹침 영역 |
| ------ | ----------------------- | ----------------------- |
| id     | bits56-63 uint64_t id:8 | -                       |
...
- Signal 총 bit 수 변경: OhmioLibraries=64, OhmioLibraries_BK=42
OhmioLibraries에만 있는 Signal:
| Signal       | 정의                                       | OhmioLibraries_BK 겹침 영역 |
| ------------ | ---------------------------------------- | ----------------------- |
...
#### RemoteSignalMsg_t
- Signal 총 bit 수 변경: OhmioLibraries=20, OhmioLibraries_BK=19
OhmioLibraries에만 있는 Signal:
| Signal   | 정의                        | OhmioLibraries_BK 겹침 영역 |
| -------- | ------------------------- | ----------------------- |
...
#### StartupErrorMsg_t
- Signal 총 bit 수 변경: OhmioLibraries=7, OhmioLibraries_BK=5
OhmioLibraries에만 있는 Signal:
| Signal                | 정의                                    | OhmioLibraries_BK 겹침 영역 |
| --------------------- | ------------------------------------- | ----------------------- |
...
| 범위        | OhmioLibraries                  | OhmioLibraries_BK                          | 판정                                         |
| --------- | ------------------------------- | ------------------------------------------ | ------------------------------------------ |
| bits6-7   | bits6-7 uint64_t reserved:2     | bits0-7 uint64_t mode:8                    | Reserved 대체 후보: OhmioLibraries reserved    |
| bits32-39 | bits32-59 uint64_t reserved1:28 | bits32-39 uint64_t brakePressure:8, // bar | Reserved 대체 후보: OhmioLibraries reserved    |
...
#### TrackAckMsg_t
- message ID 주석 변경: OhmioLibraries=0x651 TrackAckManageMsg, 0x661 TrackAckDriveMsg, OhmioLibraries_BK=0x651 TrackAckManageMsg, 0x661 TrackAckDriveMsg, 0x671 TrackAckObsMsg
#### TrackCtrlMsg_t
- message ID 주석 변경: OhmioLibraries=0x650 TrackCtrlManageMsg, 0x660 TrackCtrlDriveMsg, OhmioLibraries_BK=0x650 TrackCtrlManageMsg, 0x660 TrackCtrlDriveMsg, 0x670 TrackCtrlObsMsg
#### TrackDataMsg_t
- message ID 주석 변경: OhmioLibraries=0x652 TrackDataManageMsg, 0x662 TrackDataDriveMsg, OhmioLibraries_BK=0x652 TrackDataManageMsg, 0x662 TrackDataDriveMsg, 0x672 TrackDataObsMsg
#### WheelCountMsg_t
동일 Signal 이름의 정의 변경:
| Signal      | OhmioLibraries                   | OhmioLibraries_BK                | 판정               |
| ----------- | -------------------------------- | -------------------------------- | ---------------- |
...
## 사용자 점검 후보
- DrvExtErrorCode.Drvext_NumErrorCodes 값 변경: 8 -> 3
...
- FusionFlagsMsg_t: Reserved 대체 후보 8건
