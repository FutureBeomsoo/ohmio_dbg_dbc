...
- 비교 A: `Ohmio_lib_include` - `OhmioLibraries_36/Ohmio_lib_include/include/canbus/dbc_MsgID_main.h`
...
동일 CAN_ID 이름의 값 변경:
| Name           | Ohmio_lib_include | OhmioLibraries_BK |
| -------------- | ----------------- | ----------------- |
...
| Value | Ohmio_lib_include    | OhmioLibraries_BK          |
| ----- | -------------------- | -------------------------- |
...
#### CAN_ID_DEVIATION_REQ (0x2C5)
  - Ohmio_lib_include: DeviationReqMsg:
...
#### CAN_ID_DYNAMIC_TRACK_VALIDATION (0x300)
  - Ohmio_lib_include: DynamicTrackValidationMsg:
  - OhmioLibraries_BK: DynamicTrackValidationMsg:  bits0-15: waypoint; bits16-35: x; bits36-55: y;
#### CAN_ID_ERROR_ACCESSORY1 (0x2E)
  - Ohmio_lib_include: ErrorAccessory1:  bit0: AccessoryIncorrectPCB; bit1: AccessoryNonUniqueID; bit2:
                       AccessoryRelayOpen; bit3: AccessoryDrvInfoComms;
  - OhmioLibraries_BK: ErrorAccessory1:  bits0-63: code;
#### CAN_ID_ERROR_ACCESSORY2 (0x2F)
  - Ohmio_lib_include: ErrorAccessory2:  bit0: AccessoryIncorrectPCB; bit1: AccessoryNonUniqueID; bit2:
                       AccessoryRelayOpen; bit3: AccessoryDrvInfoComms;
  - OhmioLibraries_BK: ErrorAccessory2:  bits0-63: code;
#### CAN_ID_ERROR_DRIVE_EXT (0x24)
  - Ohmio_lib_include: ErrorDriveExt:  bit0: DrvextObsValidationCommsError; bit1: DrvextMotorNoResp; bit2:
...
#### CAN_ID_ERROR_FRONT_WHEEL_SPEED (0x80)
  - Ohmio_lib_include: ErrorFrontWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; bit2:
...
#### CAN_ID_ERROR_FUSION_DEBUG (0x725)
  - Ohmio_lib_include: ErrorFusionDebugMsg:  bit0: fusdebugReset; bit1: initialisation; bit2: steerAngleFrontInvalid;
...
#### CAN_ID_ERROR_REAR_WHEEL_SPEED (0x81)
  - Ohmio_lib_include: ErrorRearWheelSpeed:  bit0: wheel_board_config_error; bit1: wheel_safety_relay_open; bit2:
                       wheel_drv_info_comms_error;
...
#### CAN_ID_FRONT_WHEEL_CNT (0x3C)
  - Ohmio_lib_include: frontWheelCnt:  bits0-15: right_count; bits16-31: left_count; bits32-63: clock;
  - OhmioLibraries_BK: frontWheelCnt:  bits0-31: right_count; bits32-63: left_count;
#### CAN_ID_FRONT_WHEEL_EXCEPTION (0x7C0)
  - Ohmio_lib_include: frontWheelExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_FUSION_EXCEPTION (0x765)
  - Ohmio_lib_include: fusionExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_FUSION_FLAGS (0x724)
  - Ohmio_lib_include: FusionFlagsMsg:  bit0: fus_internal_reset; bit1: init_failed; bit2: front_steer_invalid; bit3:
...
#### CAN_ID_FUSION_FRONT_LONG (0x21A)
  - Ohmio_lib_include: FusionFrontLongitude:
...
#### CAN_ID_FUSION_HEIGHT (0x21D)
  - Ohmio_lib_include: FusionHeight:  bits0-22: height; bits23-34: speed; bits35-36: sync; bits37-46: delay_gnss_front;
...
#### CAN_ID_FUS_ERROR (0x25)
  - Ohmio_lib_include: FusError:  bit0: fus_internal_reset; bit1: fus_init_failed; bit2: fus_front_steer_invalid; bit3:
...
#### CAN_ID_IMU_MAG (0x727)
  - Ohmio_lib_include: IMUMag:  bits0-19: x; bits20-39: y; bits40-59: z; bits60-61: reserved; bits62-63: sync;
  - OhmioLibraries_BK: IMUMag:  bits0-15: x; bits16-31: y; bits32-47: z; bits48-49: status; bits50-61: unused;
                       bits62-63: sync;
#### CAN_ID_LOC_JOYSTICK (0x186)
  - Ohmio_lib_include: LocJoystickMsg:  bits0-9: x; bits10-19: y; bits20-23: hatswitch; bits24-31: rotation; bits32-39:
...
#### CAN_ID_LOC_MANUAL (0x185)
  - Ohmio_lib_include: LocManualMsg:  bits0-15: frontSteerAngle; bits16-23: slide; bits24-31: pressure; bit32: start;
...
#### CAN_ID_MANAGEMENT_ERROR (0x2B)
  - Ohmio_lib_include: ManagementError:  bit0: monitorError; bit1: mgtStatusError; bit2: mgtDrvInfoCommsError; bit3:
...
#### CAN_ID_OBSTACLE_DANGER_ZONE (0x122)
  - Ohmio_lib_include: ObstacleDangerZoneMsg:  bits0-12: distance; bits13-20: timeToCollision; bit21: notMoving; bit22:
...
#### CAN_ID_OBSTACLE_TRACK_DISTANCE (0x123)
  - Ohmio_lib_include: ObstacleTrackDistanceMsg:  bits0-12: trackDistance; bits13-25: sideDistanceA; bits26-38:
...
#### CAN_ID_REAR_WHEEL_CNT (0x3D)
  - Ohmio_lib_include: rearWheelCnt:  bits0-15: right_count; bits16-31: left_count; bits32-63: clock;
  - OhmioLibraries_BK: rearWheelCnt:  bits0-31: right_count; bits32-63: left_count;
#### CAN_ID_REAR_WHEEL_EXCEPTION (0x7C1)
  - Ohmio_lib_include: rearWheelExceptionMsg:  bits0-31: ex_addr; bits32-36: ex_code; bits37-39: reserved; bits40-47:
                       user_flag;
...
#### CAN_ID_REMOTE_SIGNAL (0x590)
  - Ohmio_lib_include: RemoteSignalMsg:  bits0-15: id; bit16: startBtn; bit17: emergencyBtn; bit18: horn; bit19:
                       overtake;
  - OhmioLibraries_BK: RemoteSignalMsg:  bits0-15: id; bit16: startBtn; bit17: emergencyBtn; bit18: horn;
#### CAN_ID_STARTUP_ERROR (0x23)
  - Ohmio_lib_include: StartupErrorMsg:  bit0: startupVersionError; bit1: bmsStatus; bit2: bmsErrLevel; bit3:
...
동일 entry 이름의 값 변경:
| Entry                  | Ohmio_lib_include | OhmioLibraries_BK |
| ---------------------- | ----------------- | ----------------- |
