...
namespace Ohmio
{
	...
	public:
		...
		//! Is the current mode drivable? 
		//
        //! This is similar to IsModeDriving() but it includes
        //! towing that is driving but may allow more devices to operate.
		static bool IsMovingMode(int state);
