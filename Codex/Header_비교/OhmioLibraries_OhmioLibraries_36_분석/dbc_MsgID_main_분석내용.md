...
- 비교 B: `OhmioLibraries_36` - `OhmioLibraries_36/include/canbus/dbc_MsgID_main.h`
- 파일 동일 여부: 다름
- 공백 정규화 후 동일 여부: 다름
...
### 전처리/Include 비교
Macro 값 변경:
| Macro                     | OhmioLibraries | OhmioLibraries_36 |
| ------------------------- | -------------- | ----------------- |
...
#### CAN_ID_OBSTACLE_PC_WARNING (0x707)
  - OhmioLibraries: ObstaclePcWarning:  bit0: ObsFrontTopLidarDetectingBody; bit1: ObsRearTopLidarDetectingBody; bit2:
                    ObsFrontTopLidarSectionMissing; bit3: ObsFrontRightLidarSectionMissing; bit4:
                    ObsFrontLeftLidarSectionMissing; bit5: ObsRearTopLidarSectionMissing; bit6:
                    ObsRearRightLidarSectionMissing; bit7: ObsRearLeftLidarSectionMissing; bit8:
                    ObsFrontTopLidarCalibration; bit9: ObsFrontRightLidarCalibration; bit10:
                    ObsFrontLeftLidarCalibration; bit11: ObsRearTopLidarCalibration; bit12:
                    ObsRearRightLidarCalibration; bit13: ObsRearLeftLidarCalibration; bit14: ObsKeyframeSaverError;
                    bit15: ObsOdometryTimeout; bit16: ObsKeyframeLoaderDatabaseError; bit17:
                    ObsKeyframeLoaderVersionError;
  - OhmioLibraries_36: ObstaclePcWarning:  bit0: ObsFrontTopLidarDetectingBody; bit1: ObsRearTopLidarDetectingBody;
                       bit2: ObsFrontTopLidarSectionMissing; bit3: ObsFrontRightLidarSectionMissing; bit4:
                       ObsFrontLeftLidarSectionMissing; bit5: ObsRearTopLidarSectionMissing; bit6:
                       ObsRearRightLidarSectionMissing; bit7: ObsRearLeftLidarSectionMissing; bit8:
                       ObsFrontTopLidarCalibration; bit9: ObsFrontRightLidarCalibration; bit10:
                       ObsFrontLeftLidarCalibration; bit11: ObsRearTopLidarCalibration; bit12:
                       ObsRearRightLidarCalibration; bit13: ObsRearLeftLidarCalibration; bit14:
                       ObsKeyframeDatabaseError; bit15: ObsOdometryTimeout;
