...
namespace OhmioControl
{
	...
	public:
        ...
        //! Get the max deceleration to stop at the intersection
		//
		//! If required deceleration is over this we will go throurg the traffic light
	...
	private:
        ...
        double m_deceleration;	//!< Max deceleration to stop at the intersection (m/sec^2)
